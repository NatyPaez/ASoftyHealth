...
<body>
    ...
    if($_POST){
        ...
        if($result->num_rows==1){
            ...
            $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">No encontramos ninguna cuenta .</label>';
        }
    ...
    <div class="container">
        ...
        <div class="form-body">
            ...
            <tr>
                <td class="label-td">
                    <input type="email" name="useremail" class="input-text" placeholder="Correo electronico" required>
                </td>
            </tr>
            <tr>
                <td class="label-td">
            ...
            <tr>
                <td>
                    <br>
                    <label for="" class="sub-text" style="font-weight: 280;">Si no tienes una cuenta, regístrate  </label>
                    <a href="signup.php" class="hover-link1 non-style-link">Regístrese</a>
                    <br><br><br>
                </td>
            </tr>
