...
?>
    ...
    <div class="container">
        <table border="0">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="text" name="address" class="input-text" placeholder="Ej: calle 1 N20..." required>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="text" name="nic" class="input-text" placeholder="Numero de identificación" required>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
